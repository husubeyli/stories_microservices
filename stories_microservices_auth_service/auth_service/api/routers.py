...
from ..app import app
from ..schemas.schmas import UserSchema, LoginSchema
...
def confirm_email(token):
    ...
    if user.is_active:
        return jsonify({'message': 'Account already cofirmed. Please login'}), HTTPStatus.OK
    else:
        user.is_active = True
        user.save()
        return jsonify({'message': 'You have confirmed your account. Thanks!, success'}), HTTPStatus.OK
